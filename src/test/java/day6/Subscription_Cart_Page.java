...
//      js.executeScript("window.scrollBy(0,100)");
		...
		WebElement cartLink = driver.findElement(By.xpath("//div[@class=\"shop-menu pull-right\"]/ul/li[3]"));
		cartLink.click();
		
		// Verify the text 'SUBSCRIPTION'
		WebElement subscriptionText = driver.findElement(By.xpath("//div[@class=\"single-widget\"]/h2"));
		String subscriptionTextValidation = subscriptionText.getText();
		Assert.assertEquals(subscriptionTextValidation, "SUBSCRIPTION");
